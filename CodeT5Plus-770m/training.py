...
from custom_libs.codeT5Plus_770m_model_trainer import CodeT5Plus_770m_ModelTrainer

### Constants
RANDOM_SEED=123 # Fixed seed for reproducible results
MODEL_NAME='Salesforce/codet5p-770m' # Model from Hugging Face
MODEL_RES='codeT5p-770m_model'
...
def training_test_validation(num_epochs, device):
	...
	# Initialize CodeT5Plus_770m model
	model_trainer = CodeT5Plus_770m_ModelTrainer(model_name=MODEL_NAME, save_folder=SAVE_FOLDER, device=device, num_epochs=num_epochs)
...
def arg_commandline():
	...
	parser = argparse.ArgumentParser(description="CodeT5Plus_770m model training with different validation strategies")
