...
class PIIDataLoader:
	...
	def __init__(self, train_texts=None, train_labels=None, valid_texts=None, valid_labels=None, test_texts=None, test_labels=None, tokenizer_name='Salesforce/codet5p-770m', batch_size=512):
		...
		# Initialize the CodeT5Plus 770M tokenizer
		self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name)
	
	def tokenize_data(self, texts):
		""" Tokenize a list of text samples using the CodeT5Plus-770m tokenizer """

		if not texts:
			return None
		
		# Tokenize with truncation, padding, and return PyTorch tensors
		return self.tokenizer(texts, truncation=True, padding=True, return_tensors="pt", max_length=2)#, max_length=64) # Gabriele aggiunge max lenght=128
